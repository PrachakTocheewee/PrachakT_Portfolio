...
export default function App() {
  ...
  return (
    <div className="app">
            ...
            <div className="edu-card">
              ...
              <ul className="edu-details">
                ...
                <li>
                  ...
                  theories to real-world scenarios for data-driven decisions.
                </li>
              </ul>
      ...
      {/* --- SENIOR PROJECT SECTION (ความยาวกว้างเท่า Education) --- */}
      <section id="projects" className="section fade-in">
        ...
        <div className="edu-container">
          <div className="edu-item">
            <div className="edu-dot"></div>
            <div className="edu-card senior-highlight">
              <h3>{seniorProject.title}</h3>
              <p className="edu-date">{seniorProject.subtitle}</p>
              <div className="kpi-text">{seniorProject.kpi}</div>
